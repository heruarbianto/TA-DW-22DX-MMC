...
document.querySelector("#DaurUlang").addEventListener("click", () => {
  ...
  document.querySelector("#modal_image").src = "img/p3.jpeg";
  document.querySelector("#modal_image").alt =
    "gambar daur ulang";
  document.querySelector("#modal_text").textContent =
...
document.querySelector("#VisiMisi").addEventListener("click", () => {
  ...
  document.querySelector("#modal_image").src="img/vs.jpg";
  document.querySelector("#modal_image").alt="Gambar visi misi";
  document.querySelector("#modal_text").textContent =
...
document.querySelector("#KeuntunganKeberlanjutan").addEventListener("click", () => {
  ...
  document.querySelector("#modal_image").src="img/k.jpg";
  document.querySelector("#modal_image").alt="Gambar keberlanjutan";
  document.querySelector("#modal_text").textContent =
